...
set OBJS=
for %%f in (main ui iso9660 theme vfs isowrite preview eltorito dragdrop worker udf udfwrite container strutil xdvdfs xdvdwrite gcmwrite opera deflate bzip2 zstd rvz writers gamecube audio) do (
