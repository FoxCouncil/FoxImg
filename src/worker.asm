...
g_saveSuffix    dd offset szGzSuffix, offset szZipSuffix, offset szCsoSuffix, offset szIszSuffix, offset szDaxSuffix
                ...
                dd offset szEcmSuffix, offset szNrgSuffix, offset szZsoSuffix, offset szChdSuffix, offset szRawSuffix
g_saveWriter    dd offset GzCompressFile, 0, offset CsoCompressFile, offset IszCompressFile, offset DaxCompressFile
                ...
                dd offset EcmWrapFile, offset NrgWrapFile, offset ZsoCompressFile, offset ChdWriteFile, offset RawWrapFile
WSTR szIsoDot, <.iso>
szPctFmt        dw '%','s','.','.','.',' ',' ','%','u','%','%',0
szDotsFmt       dw '%','s','.','.','.',0
