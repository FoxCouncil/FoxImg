...
szAboutText    db 'FoxImg v1.4 - a small native disc image tool. 33 readable formats from ISO to CHD, seven built-in codecs, CD audio playback, one dependency-free exe.', 0
WSTR szSaved, <Saved>
